...
urlpatterns = [
    ...
    path('contactus/home.html', views.contact, name='contact'),
    path('profile/', views.ProfileView.as_view(), name='profile'),
    path('address/', views.address, name='address'),
    path('orders/', views.orders, name='orders'),
    path('checkout/', views.checkout, name='checkout'),
    path('paymentdone/', views.payment_done, name='paymentdone'),
    path('sistergift/', views.sistergift, name='sistergift'),
    path('sistergift/<slug:data>', views.sistergift, name='sistergiftdata'),
    ...
    path('birthdaycard/<slug:data>/', views.birthdaycard, name='birthdaycarddata'),
    path('lovecard/', views.lovecard, name='lovecard'),
    path('lovecard/<slug:data>/', views.lovecard, name='lovecarddata'),
    ...
    path('password-reset-complete/',auth_views.PasswordResetCompleteView.as_view(template_name='password_reset_complete.html'),name='passwordresetcomplete'),
